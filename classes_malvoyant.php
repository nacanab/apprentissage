...
<?php include('nav.php'); ?>
  ...
  <div class="container">
    <h1>Les vidéos sont affichées en mode contraste élevé pour une meilleure visibilité, la police des écritures est également plus grande.</h1>
    <div class="course-list">
      <div class="course-card">
        <div class="course-content">
          ...
          <video controls>
                <source src="video_maths.mp4" type="video/mp4">
                Votre navigateur ne prend pas en charge la balise vidéo.
            </video>
            <a href="exercice.php?subject=svt&classe=<?php echo $classe; ?>" class="button">Voir les exercices</a>
        </div>
      </div>
      ...
      <div class="course-card">
        <div class="course-content">
          ...
          <video controls>
                <source src="video_francais.mp4" type="video/mp4">
                Votre navigateur ne prend pas en charge la balise vidéo.
            </video>
            <a href="exercice.php?subject=maths&classe=<?php echo $classe; ?>" class="button">Voir les exercices</a>
        </div>
      </div>
      ...
      <div class="course-card">
        <div class="course-content">
          ...
          <video controls>
                <source src="video_svt.mp4" type="video/mp4">
                Votre navigateur ne prend pas en charge la balise vidéo.
            </video>
            <a href="exercice.php?subject=francais&classe=<?php echo $classe; ?>" class="button">Voir les exercices</a>
        </div>
      </div>
    </div>
  </div>
