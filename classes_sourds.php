...
<?php include('nav.php'); ?>
  ...
  <div class="container">
    <h1>Voici vos cours avec sous-titres:</h1>
      ...
      <div class="course-card">
        <div class="course-content">
          ...
          <video controls>
            ...
            <track src="sous_titres_maths.vtt" kind="subtitles" srclang="fr" label="Français">
      ...
      <div class="course-card">
        <div class="course-content">
          ...
          <video controls>
            ...
            <track src="sous_titres_francais.vtt" kind="subtitles" srclang="fr" label="Français">
            Votre navigateur ne prend pas en charge la balise vidéo.
        </video>
      ...
      <div class="course-card">
        <div class="course-content">
          ...
          <video controls>
            ...
            <track src="sous_titres_svt.vtt" kind="subtitles" srclang="fr" label="Français">
            Votre navigateur ne prend pas en charge la balise vidéo.
        </video>
